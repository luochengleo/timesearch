            ...
            context('with :target', function () {
                ...
                context('with missing score key', function () {
                    it('throws error', function () {
                        ...
                        // when
                        var lambda = function () {
                            self.raty({ target: '#hint', targetFormat: '' });
                        };
