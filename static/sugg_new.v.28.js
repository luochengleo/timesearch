...
sugTemplate.prototype.vmap = {"60": ".v.4", "69": ".v.1", "91": ".v.1", "97": ".v.4", "113": ".v.1", "137": ".v.1", "145": ".v.2", "163": ".v.2", "164": ".v.2", "166": ".v.1", "191": ".v.3", "206": ".v.1", "210": ".v.3", "244": ".v.1", "273": ".v.1", "312": ".v.1", "317": ".v.3", "376": ".v.1", "322": ".v.1", "330": ".v.1", "349": ".v.2", "10001": ".v.1", "10002": ".v.1", "10004": ".v.1"};
...
sugTemplate.prototype.build = function (a, d, n, l, c) {
    ...
    a.onclick = function (r) {
        ...
        try {
            r = r || window.event;
            var t = ((r.target) ? r.target : r.srcElement), q;
            while (t && t.tagName) {
...
sugTemplate.prototype.buildVR = function (b, c, d) {
    if (typeof this["build" + c.type] == "function") {
        try {
            var a = c.docs, j = a[0], f = this.parseXML(a[0].xml);
            try {
...
function sogouSugg(newPara) {
    ...
    function handleData(results) {
        ...
        for (var i = 0; i < jsonData.length && i < 10; i++) {
            ...
            if (i == 0 && jsonDataTongji2[0] == "3") {
                tmpLi.innerHTML = '<strong style="color:red">���Ƿ�Ҫ�ң�</strong><strong>' + tmpLi.innerHTML + "</strong>"
            }
        ...
        function form_submit(a, b, c) {
            ...
            if (suggestWordId != -1) {
                ...
                if (jsonDataTongji.length > 0) {
                    query_inputs = {w: suggestRid, oq: userInputString, ri: suggestWordId, sourceid: "sugg", stj: jsonDataTongji[suggestWordId], stj2: goTongjiId[suggestWordId], stj0: jsonDataTongji0[suggestWordId], stj1: jsonDataTongji1[suggestWordId], hp: hasPersonal, hp1: hasPersonal1}
                }
            }
    ...
    function getSiteData(txt, pos, cnt) {
        ...
        if (sitecache[txt]) {
            ...
            setTimer2 = setTimeout(function () {
                contentDiv.innerHTML = '<div class="loading">�������룬���Ժ�...</div>'
            }, 100);
            clearTimeout(setTimer1);
    ...
    function handleSiteData(data, cnt) {
        ...
        if (contentDiv) {
            ...
            if (!template.build(contentDiv, data, jsonData, goTongjiId, vrFlag)) {
                if (contentDiv.innerHTML != '<div class="loading">�������룬���Ժ�...</div>') {
                    contentDiv.innerHTML = '<div class="loading">�������룬���Ժ�...</div>'
                }
                clearTimeout(setTimer1);
                clearTimeout(setTimer3);
    ...
    sugTemplate.prototype.buildZhiDa = function (div, context, tempCode) {
        var loopPtn = /<!--\s*LOOP\s+SET=\$\{(.*?)\}.*?-->/, endPtn = /<!--\s*ENDLOOP\s*-->/, loopMat = null, endMat = null;
